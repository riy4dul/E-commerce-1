<footer class="site-footer footer-opt-1">
            ...
            <div class="container">
                    ...
                    <div class="row">
                        <div class="col-md-3 col-lg-3 col-xs-6 col">
                            <strong class="logo-footer">
                                <a href="{{ URL::to('/')}}"><img src="{{asset('/') }}frontend/images/media/index1/logo-footer.png" alt="logo"></a>
                            </strong>
                ...
                <!-- <div class="payment-methods">
                    ...
                    <div class="block-content">
                        <img alt="payment" src="{{asset('/') }}frontend/images/media/index1/payment1.png">
                        <img alt="payment" src="{{asset('/') }}frontend/images/media/index1/payment2.png">
                        ...
                        <img alt="payment" src="{{asset('/') }}frontend/images/media/index1/payment7.png">
                        <img alt="payment" src="{{asset('/') }}frontend/images/media/index1/payment8.png">
                        <img alt="payment" src="{{asset('/') }}frontend/images/media/index1/payment9.png">
                    </div>
                </div> -->
                ...
                <div class="copyright">
                    ...
                    Copyright © 2018 Riyadul All Rights Reserved. Developed <a href="https://fb.com/">Riyadul</a>
