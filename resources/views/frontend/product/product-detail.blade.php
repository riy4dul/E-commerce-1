                            ...
                            <div class="col-sm-6 col-md-6 col-lg-6">
                                ...
                                <div class="product-media media-horizontal">
                                    ...
                                    <div class="image_preview_container images-large">
                                        ...
                                        <img id="img_zoom" src="{{asset('backend/images/product/'.$product->product_image)}}" alt="">
                                    ...
                                    <div class="product-add-form">
                                            ...
                                            <div class="product-options-wrapper">
                                                ...
                                                <div class="form-qty">
                                                    ...
                                                    <div class="control">
                                                        ...
                                                        <input type="number" class="form-control input-qty" name="qty" value="1" min="1">
                                            ...
                                            <div class="product-options-bottom clearfix">
                                                ...
                                                <div class="actions">
                                                    ...
                                                    {{--    <a class="btn btn-cart" title="Add to Cart" style="background-color: #ff3366;" type="submit"><span>Add to Cart</span></a> --}}
                                                    
                                                    

                                                    <button type="submit" title="Add to Cart" class="action btn-cart"style="background-color: #ff3366;">
                                ...
                                "992":{"items":1}
                                    ...
                                    <div class="item">
                                        ...
                                        <div class="product-item product-item-opt-2">
                                            <div class="product-item-info">
                                                <div class="product-item-photo">
                                                    <a class="product-item-img" href="{{route('productDetails',$allproduct->id)}}"><img alt="product name" src="{{asset('backend/images/product/'.$allproduct->product_image)}}"></a>
                                                </div>
                                                <div class="product-item-detail">
                                                    <strong class="product-item-name"><a href="{{route('productDetails',$allproduct->id)}}">{{$allproduct->product_name}}</a></strong>
                                                    <div class="clearfix">
                                                        <div class="product-item-price">
                                                            <span class="price">{{$allproduct->product_price}} ৳</span>
                                                        </div>
                                                        <div class="product-reviews-summary">
                                                            <div class="rating-summary">
                                                                <div title="70%" class="rating-result">
                                                                    <span style="width:70%">
                                                                        <span>{{$product->product_price+100}} ৳</span>
                                                                    </span>
                                                                </div>
                                                            </div>
                                                        </div>
